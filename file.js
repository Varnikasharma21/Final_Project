...
catch(err)
{
  ...
  function listFiles() {
    ...
    .then((folders) => {
      ...
      art.innerHTML = `<i class="fa-solid fa-2x fa-file" onclick='opendetails(${folder.documentId},"${folder.documentName}","${folder.createdBy}",
      "${folder.createdAt}")'></i>
...
function deletefolder(folder) {
  ...
  function opendetails(documentid,documentname,createdby,createdat)
{
  alert(
